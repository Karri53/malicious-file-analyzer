...
export default function Nav() {
  ...
  const linkActive = isDark ? '#C9A84C' : '#8B6914'
    ...
    <nav style={{
      ...
      <div style={{ width: '100%', maxWidth: '1400px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', cursor: 'pointer' }} onClick={() => navigate('/')}>
          <img src="/NexusLogo.png" alt="NEXUS" style={{ height: '44px', width: 'auto', objectFit: 'contain' }} />
          <div>
        ...
        <button
          ...
          style={{
            ...
            cursor: 'pointer', fontFamily: 'DM Sans', fontSize: '14px', fontWeight: '500',
